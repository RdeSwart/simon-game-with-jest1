...
// Using Jest to create an alert if wrong button is pressed(called a "spy"):
// the first argument to spyOn is the window and  the second is the name of the method, in this case "alert".
